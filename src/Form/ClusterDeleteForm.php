...
class ClusterDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete the cluster %title?', array('%title' => $this->entity->label()));
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $storage = \Drupal::entityTypeManager()->getStorage('elasticsearch_index');
